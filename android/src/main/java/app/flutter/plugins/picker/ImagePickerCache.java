...
class ImagePickerCache {
  ...
  private static final String FLUTTER_picker_IMAGE_PATH_KEY =
      "flutter_picker_image_path";
  private static final String SHARED_PREFERENCE_ERROR_CODE_KEY = "flutter_picker_error_code";
  private static final String SHARED_PREFERENCE_ERROR_MESSAGE_KEY =
      "flutter_picker_error_message";

  private static final String SHARED_PREFERENCE_MAX_WIDTH_KEY = "flutter_picker_max_width";

  private static final String SHARED_PREFERENCE_MAX_HEIGHT_KEY = "flutter_picker_max_height";

  private static final String SHARED_PREFERENCE_IMAGE_QUALITY_KEY =
      "flutter_picker_image_quality";

  private static final String SHARED_PREFERENCE_TYPE_KEY = "flutter_picker_type";
  private static final String SHARED_PREFERENCE_PENDING_IMAGE_URI_PATH_KEY =
      "flutter_picker_pending_image_uri";

  @VisibleForTesting
  static final String SHARED_PREFERENCES_NAME = "flutter_picker_shared_preference";
  ...
  void saveResult(
    ...
    SharedPreferences.Editor editor = prefs.edit();
    if (path != null) {
      editor.putString(FLUTTER_picker_IMAGE_PATH_KEY, path);
    }
    if (errorCode != null) {
  ...
  Map<String, Object> getCacheMap() {
    ...
    if (prefs.contains(FLUTTER_picker_IMAGE_PATH_KEY)) {
      final String imagePathValue = prefs.getString(FLUTTER_picker_IMAGE_PATH_KEY, "");
